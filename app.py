...
def resultado():
    ...
    vencedores = [partido for partido in ["Partido A", "Partido B", "Partido C"] if votos[partido] == max_votos and max_votos > 0]
    ...
    return render_template_string("""
        ...
        <body>
            ...
            <br>
            <p>Acesse novamente: <a href="{{ url_for('index') }}">Página de votação</a></p>
        </body>
        </html>
